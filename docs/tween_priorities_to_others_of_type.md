...
| **go-back-to-origin-after-dragging** | A dragged card was released                      | `Translation` and `Scale` | **30** (see note)   |
...
note: Priority gets an additional `TWEEN_PRIORITY_ADDITION_ON_ORIGIN_SET` if sliding to a new origin
